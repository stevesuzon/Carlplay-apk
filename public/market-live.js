...
var row=[m.area,m.kind||'marche',m.name,m.city||'',m.day,m.hours||'',m.kind==='brocante'?'Brocante':'Marché',m.merchants||'',m.address||'',m.country||currentCountry,m.latitude,m.longitude,m.draw||'',m.registration||'',m.note||'',m.phone||'',m.date_label||''];
