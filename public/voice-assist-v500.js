(function(){
'use strict';
if(window.__voiceClean500)return;window.__voiceClean500=1;
...
function start(e){
 ...
 timer=setTimeout(function(){
   if(!active)return;
   // V500 : la voix se déclenche exactement à 1,20 s pendant que le doigt est encore posé.
   fireLong(active);
 },PRESS);
}
function move(e){
...
window.CouteauVoice={enabled:on,setEnabled:setOn,speak:function(t){return armed?say(t):false},pageArmed:function(){return armed},activatePage:arm,buildMarket:market,version:'V500'};
})();