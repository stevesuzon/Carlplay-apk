...
function end(e){
 ...
 if(!el)return;
 if(long){
   // Un appui long vocal ne doit JAMAIS ouvrir le bouton, le lien ou la fiche.
   suppress(el,2200);
   stop(e);
   if(!armed){
     arm();
...
window.CouteauVoice={enabled:on,setEnabled:setOn,speak:function(t){return armed?say(t):false},pageArmed:function(){return armed},activatePage:arm,buildMarket:market,version:'V499'};
})();