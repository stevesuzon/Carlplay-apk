const CACHE = "carplay-v5-20260912-email-all-users-v153";
...
const CORE = [
  ...
  "/subscription-web.js?v=70-email-all-users-v153",
  "/home-work.css?v=64",
  "/home-work.js?v=64",
  ...
  "/modification-demande.html?v=20260912-email-all-users-v153",
