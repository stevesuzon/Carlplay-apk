(function(){
  ...
  function releaseMediaV492(delay){
    setTimeout(function(){
      try{
  ...
  window.CouteauVoice={enabled:enabled,setEnabled:setEnabled,speak:speak,buildMarket:buildMarket,pressMs:PRESS_MS,version:'V494'};
})();
