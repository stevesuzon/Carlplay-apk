(function(){
  ...
  function voiceUnlockedV456(){
    return window.__carplayVoicePageUnlockedV504===true;
  }
  function unlockVoiceV456(){
    voiceAwakeV423=true;
    window.__carplayVoicePageUnlockedV504=true;
  ...
  try{
    var v504style=document.createElement('style');
    v504style.id='voiceImageProtectionV504';
    v504style.textContent='img{-webkit-touch-callout:none!important;-webkit-user-drag:none!important;pointer-events:none!important}button,a,[role="button"],[onclick],[data-voice-card]{-webkit-touch-callout:none!important;-webkit-user-select:none!important;user-select:none!important}';
    (document.head||document.documentElement).appendChild(v504style);
  }catch(_){}
  installNoSelectV389();
  ...
  window.CouteauVoice={enabled:enabled,setEnabled:setEnabled,speak:speak,buildMarket:buildMarket,pressMs:PRESS_MS,version:'V504'};
})();
