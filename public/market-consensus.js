(function sharedMarketConsensus(){
  ...
  style.textContent='.card{position:relative}.marketVerificationDot{position:absolute;right:13px;top:13px;width:19px;height:19px;border-radius:50%;border:2px solid #fff;box-shadow:0 0 9px #000,0 0 7px currentColor;z-index:2}.marketVerificationDot.green{background:#24c96b;color:#24c96b}.marketVerificationDot.orange{background:#f39b19;color:#f39b19}.verificationSent{display:inline-flex;align-items:center;color:#f39b19;font-size:14px;font-weight:900}.sharedMarketPhoto{display:block;width:min(150px,100%);aspect-ratio:1/1;height:auto;margin:10px auto;border:3px solid #f39b19;border-radius:14px;object-fit:contain;background:#000;cursor:pointer}.addMarketPhoto{display:flex;width:100%;max-width:360px;min-height:105px;margin:10px 0;align-items:center;justify-content:center;border:3px dashed #62d8ff;border-radius:14px;background:#081727;color:#62d8ff;text-align:center;text-decoration:none;font-size:18px;font-weight:950}.sharedPhotoModal{position:fixed;inset:0;z-index:400000;display:none;align-items:center;justify-content:center;padding:18px;background:#000e}.sharedPhotoModal.open{display:flex}.sharedPhotoModal img{display:block;max-width:94vw;max-height:86vh;border:3px solid #f39b19;border-radius:16px;background:#000}.sharedPhotoClose{position:fixed;right:20px;top:20px;width:48px;height:48px;border:0;border-radius:50%;background:#f39b19;color:#111;font-size:28px;font-weight:950}';
