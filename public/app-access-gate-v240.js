...
function showAutoradioInstallPrompt(){
  ...
  o.querySelector('#autoradioInstallYesV374').onclick=function(){
    ...
    var a=document.createElement('a');a.href='/download-autoradio.apk?install=1&t='+Date.now();a.download='Couteau-Suisse-Autoradio.apk';a.style.display='none';document.body.appendChild(a);a.click();setTimeout(function(){
      a.remove();
      o.innerHTML='<div style="width:min(560px,95vw);background:#081521;border:5px solid #35d06f;border-radius:28px;padding:26px 20px;color:#fff;text-align:center;box-shadow:0 20px 80px #000"><div style="font-size:64px;line-height:1">✅</div><div style="margin-top:10px;font:950 34px/1.08 Arial;color:#72eba5">APPLICATION TÉLÉCHARGÉE</div><div style="margin-top:18px;padding:18px;border:4px solid #ffd43b;border-radius:20px;background:#2d2600;font:950 25px/1.2 Arial;color:#fff">👇 APPUYEZ MAINTENANT SUR<br><span style="display:block;margin-top:8px;color:#ffd43b;font-size:27px">Couteau-Suisse-Autoradio.apk</span></div><div style="margin-top:18px;font:950 25px/1.25 Arial">PUIS APPUYEZ SUR<br><span style="display:inline-block;margin-top:8px;padding:10px 22px;border-radius:14px;background:#19a85b;color:#fff;font-size:29px">INSTALLER</span></div><div style="margin-top:18px;font:850 16px/1.4 Arial;color:#d9e5ef">Le fichier se trouve dans la notification de téléchargement ou dans <b>Chrome → Téléchargements</b>.</div><button id="autoradioInstallDoneV375" type="button" style="width:100%;min-height:58px;margin-top:20px;border:0;border-radius:14px;background:#414b59;color:#fff;font:900 18px Arial">FERMER</button></div>';
      o.querySelector('#autoradioInstallDoneV375').onclick=function(){o.remove()};
    },1200);
  };
}
