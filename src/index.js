...
async function contestStatus(request,env){
  ...
  let sub=await contestSubscription(env,data),profile=null,participant=null,messages=[],questions=[],scoreSummary=null,bonusState=null,bonusProgress=null,onboarding=null;
