...
public class MainActivity extends Activity {
    ...
    private String autoradioUiScript() {
        ...
        return "(function(){" +
                ...
                "['#addressCreateQuote','#simpleQuoteBtn','#genericQuoteModal','#simpleQuoteOverlay'].forEach(function(q){var e=document.querySelector(q);if(e)e.style.display='none';});['#directArticle','#directArticleModal','#homeArticleBtn'].forEach(function(q){var e=document.querySelector(q);if(e)e.remove();});document.querySelectorAll('.articleTile').forEach(function(e){e.remove();});" +
