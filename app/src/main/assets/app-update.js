(function(){
  var UPDATE_ID='2026-08-27-notification-visible-2';
  var DETAILS=[
    'Bulle de notification de mise à jour corrigée sur l’accueil',
    'Affichage pendant 4 secondes',
    'Appui sur la bulle = détail de ce qui a été mis à jour',
    'Appui à côté = fermeture',
    'Navigation GPS des marchés améliorée',
    'Installation iPhone et Android guidée'
  ];
  ...
  ready(function(){
    ...
    var toast=document.createElement('div');toast.className='cpUpdateToast';toast.textContent='🔄 Mise à jour — notifications + GPS + installation';
    ...
    modal.innerHTML='<h2>Ce qui a été mis à jour</h2><ul>'+DETAILS.map(function(x){return '<li>'+x+'</li>';}).join('')+'</ul><div class="hint">Appuyez à côté de cette bulle pour fermer.</div>';
